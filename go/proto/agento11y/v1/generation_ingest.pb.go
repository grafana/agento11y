// Agento11y ingest schema. This is the source of truth for every SDK.
...
func (GenerationMode) Descriptor() protoreflect.EnumDescriptor {
	return file_agento11y_v1_generation_ingest_proto_enumTypes[0].Descriptor()
}

func (GenerationMode) Type() protoreflect.EnumType {
	return &file_agento11y_v1_generation_ingest_proto_enumTypes[0]
}
...
func (GenerationMode) EnumDescriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{0}
}
...
func (MessageRole) Descriptor() protoreflect.EnumDescriptor {
	return file_agento11y_v1_generation_ingest_proto_enumTypes[1].Descriptor()
}

func (MessageRole) Type() protoreflect.EnumType {
	return &file_agento11y_v1_generation_ingest_proto_enumTypes[1]
}
...
func (x *ExportGenerationsRequest) Reset() {
	*x = ExportGenerationsRequest{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[0]
...
func (x *ExportGenerationsResponse) Reset() {
	*x = ExportGenerationsResponse{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ExportGenerationResult) Reset() {
	*x = ExportGenerationResult{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ModelRef) Reset() {
	*x = ModelRef{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *PartMetadata) Reset() {
	*x = PartMetadata{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PartMetadata) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{4}
}
...
func (x *ToolCall) Reset() {
	*x = ToolCall{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ToolCall) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{5}
}
...
func (x *ToolResult) Reset() {
	*x = ToolResult{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ToolResult) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{6}
}
...
func (x *Media) Reset() {
	*x = Media{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Media) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{7}
}
...
func (x *Part) Reset() {
	*x = Part{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Part) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{8}
}
...
func (x *Part) GetMedia() *Media {
	if x != nil {
		if x, ok := x.Payload.(*Part_Media); ok {
			return x.Media
		}
	}
	return nil
...
type Part_Media struct {
	Media *Media `protobuf:"bytes,6,opt,name=media,proto3,oneof"`
}
...
func (*Part_Media) isPart_Payload() {}

type Message struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Role          MessageRole            `protobuf:"varint,1,opt,name=role,proto3,enum=agento11y.v1.MessageRole" json:"role,omitempty"`
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
...
func (x *Message) Reset() {
	*x = Message{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{9}
}
...
func (x *ToolDefinition) Reset() {
	*x = ToolDefinition{}
	mi := &file_agento11y_v1_generation_ingest_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ToolDefinition) Descriptor() ([]byte, []int) {
	return file_agento11y_v1_generation_ingest_proto_rawDescGZIP(), []int{10}
}
...
type Generation struct {
	...
	Mode                GenerationMode         `protobuf:"varint,4,opt,name=mode,proto3,enum=agento11y.v1.GenerationMode" json:"mode,omitempty"`
...
var File_agento11y_v1_generation_ingest_proto protoreflect.FileDescriptor

const file_agento11y_v1_generation_ingest_proto_rawDesc = "" +
	"\n" +
	"$agento11y/v1/generation_ingest.proto\x12\fagento11y.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"V\n" +
	"\x18ExportGenerationsRequest\x12:\n" +
	"\vgenerations\x18\x01 \x03(\v2\x18.agento11y.v1.GenerationR\vgenerations\"[\n" +
	"\x19ExportGenerationsResponse\x12>\n" +
	"\aresults\x18\x01 \x03(\v2$.agento11y.v1.ExportGenerationResultR\aresults\"o\n" +
	...
	"\x04Part\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.agento11y.v1.PartMetadataR\bmetadata\x12\x14\n" +
	"\x04text\x18\x02 \x01(\tH\x00R\x04text\x12\x1c\n" +
	"\bthinking\x18\x03 \x01(\tH\x00R\bthinking\x125\n" +
	"\ttool_call\x18\x04 \x01(\v2\x16.agento11y.v1.ToolCallH\x00R\btoolCall\x12;\n" +
	"\vtool_result\x18\x05 \x01(\v2\x18.agento11y.v1.ToolResultH\x00R\n" +
	"toolResult\x12+\n" +
	"\x05media\x18\x06 \x01(\v2\x13.agento11y.v1.MediaH\x00R\x05mediaB\t\n" +
	"\apayload\"v\n" +
	"\aMessage\x12-\n" +
	"\x04role\x18\x01 \x01(\x0e2\x19.agento11y.v1.MessageRoleR\x04role\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12(\n" +
	"\x05parts\x18\x03 \x03(\v2\x12.agento11y.v1.PartR\x05parts\"\xa2\x01\n" +
	...
	"\x0eoperation_name\x18\x03 \x01(\tR\roperationName\x120\n" +
	"\x04mode\x18\x04 \x01(\x0e2\x1c.agento11y.v1.GenerationModeR\x04mode\x12\x19\n" +
	"\btrace_id\x18\x05 \x01(\tR\atraceId\x12\x17\n" +
	"\aspan_id\x18\x06 \x01(\tR\x06spanId\x12,\n" +
	"\x05model\x18\a \x01(\v2\x16.agento11y.v1.ModelRefR\x05model\x12\x1f\n" +
	"\vresponse_id\x18\b \x01(\tR\n" +
	"responseId\x12%\n" +
	"\x0eresponse_model\x18\t \x01(\tR\rresponseModel\x12#\n" +
	"\rsystem_prompt\x18\n" +
	" \x01(\tR\fsystemPrompt\x12+\n" +
	"\x05input\x18\v \x03(\v2\x15.agento11y.v1.MessageR\x05input\x12-\n" +
	"\x06output\x18\f \x03(\v2\x15.agento11y.v1.MessageR\x06output\x122\n" +
	"\x05tools\x18\r \x03(\v2\x1c.agento11y.v1.ToolDefinitionR\x05tools\x12.\n" +
	"\x05usage\x18\x0e \x01(\v2\x18.agento11y.v1.TokenUsageR\x05usage\x12\x1f\n" +
	"\vstop_reason\x18\x0f \x01(\tR\n" +
	"stopReason\x129\n" +
	"\n" +
	"started_at\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\tstartedAt\x12=\n" +
	"\fcompleted_at\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampR\vcompletedAt\x126\n" +
	"\x04tags\x18\x12 \x03(\v2\".agento11y.v1.Generation.TagsEntryR\x04tags\x123\n" +
	"\bmetadata\x18\x13 \x01(\v2\x17.google.protobuf.StructR\bmetadata\x12;\n" +
	"\rraw_artifacts\x18\x14 \x03(\v2\x16.agento11y.v1.ArtifactR\frawArtifacts\x12\x1d\n" +
	"\n" +
	...
	"\x12_effective_version\"_\n" +
	"\x1aExportWorkflowStepsRequest\x12A\n" +
	"\x0eworkflow_steps\x18\x01 \x03(\v2\x1a.agento11y.v1.WorkflowStepR\rworkflowSteps\"_\n" +
	"\x1bExportWorkflowStepsResponse\x12@\n" +
	"\aresults\x18\x01 \x03(\v2&.agento11y.v1.ExportWorkflowStepResultR\aresults\"e\n" +
	...
	"\x04tags\x18\n" +
	" \x03(\v2$.agento11y.v1.WorkflowStep.TagsEntryR\x04tags\x122\n" +
	...
	"\x1cARTIFACT_KIND_PROVIDER_EVENT\x10\x042\x7f\n" +
	"\x17GenerationIngestService\x12d\n" +
	"\x11ExportGenerations\x12&.agento11y.v1.ExportGenerationsRequest\x1a'.agento11y.v1.ExportGenerationsResponse2\x87\x01\n" +
	"\x19WorkflowStepIngestService\x12j\n" +
	"\x13ExportWorkflowSteps\x12(.agento11y.v1.ExportWorkflowStepsRequest\x1a).agento11y.v1.ExportWorkflowStepsResponseBOZ>github.com/grafana/agento11y/go/proto/agento11y/v1;agento11yv1\xaa\x02\fAgento11y.V1b\x06proto3"

var (
	file_agento11y_v1_generation_ingest_proto_rawDescOnce sync.Once
	file_agento11y_v1_generation_ingest_proto_rawDescData []byte
)

func file_agento11y_v1_generation_ingest_proto_rawDescGZIP() []byte {
	file_agento11y_v1_generation_ingest_proto_rawDescOnce.Do(func() {
		file_agento11y_v1_generation_ingest_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agento11y_v1_generation_ingest_proto_rawDesc), len(file_agento11y_v1_generation_ingest_proto_rawDesc)))
	})
...
func file_agento11y_v1_generation_ingest_proto_init() {
	if File_agento11y_v1_generation_ingest_proto != nil {
		return
	}
	file_agento11y_v1_generation_ingest_proto_msgTypes[8].OneofWrappers = []any{
		(*Part_Text)(nil),
		(*Part_Thinking)(nil),
		(*Part_ToolCall)(nil),
		(*Part_ToolResult)(nil),
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_agento11y_v1_generation_ingest_proto_goTypes,
		DependencyIndexes: file_agento11y_v1_generation_ingest_proto_depIdxs,
		EnumInfos:         file_agento11y_v1_generation_ingest_proto_enumTypes,
		MessageInfos:      file_agento11y_v1_generation_ingest_proto_msgTypes,
	}.Build()
	File_agento11y_v1_generation_ingest_proto = out.File
	file_agento11y_v1_generation_ingest_proto_goTypes = nil
	file_agento11y_v1_generation_ingest_proto_depIdxs = nil
}
