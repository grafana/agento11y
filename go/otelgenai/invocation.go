...
type Part struct {
	...
	// by key. A completion hook uses them to carry data the conventions have
...
type Invocation struct {
	...
	// End resolves it before the completion hooks run, so a hook that assigns
	...
	// Vendor carries instrumentation-specific data for completion hooks. This
