...
// Fix branch and identity so host Git settings do not affect the fixture.
...
describe("selectAutoTags", () => {
  ...
  const cases: Array<{
    ...
    },
    {
      ...
      unknown: ["team"],
      namesSet: true,
      warns: "contains no supported tag names",
    },
    {
...
describe("resolveAutoTags", () => {
  ...
  beforeEach(() => {
    dir = mkdtempSync(join(tmpdir(), "agento11y-dsh-autotag-"));
  });
