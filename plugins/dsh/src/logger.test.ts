...
describe("logFilePath", () => {
  ...
  it("falls back to an existing legacy sigil state dir", () => {
    const dir = mkdtempSync(join(tmpdir(), "agento11y-dsh-state-"));
    try {
...
describe("logger", () => {
  ...
  beforeEach(() => {
    dir = mkdtempSync(join(tmpdir(), "agento11y-dsh-log-"));
    process.env.XDG_STATE_HOME = dir;
