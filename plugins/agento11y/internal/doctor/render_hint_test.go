...
// nothing reports "no problems detected", because an unconfigured pipeline is a
// warning and never an error, and that reader is exactly who the paste block is
// for.
